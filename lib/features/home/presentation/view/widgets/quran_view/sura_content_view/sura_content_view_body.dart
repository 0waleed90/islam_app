...
class SuraContentViewBody extends StatelessWidget {
  const SuraContentViewBody({super.key, required this.sura});
      ...
      body:Padding(
        ...
        child: Column(
          children: [
            Column(
              children: [
                SuraContentViewAppBar(enSoraName: sura.englishName,),
                TopItemQuranHadith(
                  centerText: sura.name,
                  textStyle: Styles.textStyle24,
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * .65,
                  child: SuraContentListView(sura: sura,),
                ),
